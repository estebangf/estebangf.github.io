    ...
    <footer className="bg-gray-900 text-gray-300 py-10">
      <div className="max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="mt-6 flex justify-center space-x-4">
          <a href="https://clip-to.vercel.com/IJi2ylq" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
          ...
          <a href="https://clip-to.vercel.com/uf57oX9" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
